...
//                      Collectors.toMap(Meal::getDate, Meal::getCalories, Integer::sum)
    ...
    public static List<Meal> getTestMeals() {
        return Arrays.asList(
                ...
                new Meal(LocalDateTime.of(2015, Month.MAY, 31, 13, 0), "Обед", 500),
                new Meal(LocalDateTime.of(2015, Month.MAY, 31, 20, 0), "Ужин", 510),
                new Meal(LocalDateTime.of(2015, Month.JUNE, 1, 9, 0), "Завтрак", 500),
                new Meal(LocalDateTime.of(2015, Month.JUNE, 1, 12, 0), "Обед", 1000),
                new Meal(LocalDateTime.of(2015, Month.JUNE, 1, 18, 0), "Ужин", 700),
                new Meal(LocalDateTime.of(2015, Month.JUNE, 2, 8, 30), "Завтрак", 650),
